...
public class FortuneController {
	...
	// 2. 이 메소드로 어떤 요청을 처리할건지 @RequestMapping 어노테이션에 명시한다.
	@RequestMapping("/fortune.do")
	public String fortune(HttpServletRequest request) { // 리턴 type 은 String, 메소드명은 마음대로 지울 수 있다.
		/*
		...
		String fortuneToday="동쪽으로 가면 귀인이 있어요.";
		// request scope 에 담는다.
